...
We're working on some new tooling called [vibe synthesis](../vibe-synthesis.md) to help with this.
...
<strong>@lilypad.trace(name="Answer Question", versioning="automatic", mode="wrap") 
...
<strong>trace: lilypad.Trace[str | None] = answer_question("What is the capital of France?")
</strong>print(trace.response)  # original response
# > The capital of France is Paris.

<strong>trace.annotate(label="PASS", reason="The answer was correct")
</strong></code></pre>
