...
<div className="flex flex-col md:flex-row justify-center items-center gap-4 my-8 w-full px-4">
  <ButtonLink href="./quickstart" className="w-full md:w-1/3 justify-center">
    <RocketIcon className="size-3.5" aria-hidden="true" /> Quick Start
  </ButtonLink>
  <ButtonLink href="../learn" className="w-full md:w-1/3 justify-center">
    <BookOpenIcon className="size-3.5" aria-hidden="true" /> Learn More
  </ButtonLink>
  <ButtonLink href="https://join.slack.com/t/mirascope-community/shared_invite/zt-2ilqhvmki-FB6LWluInUCkkjYD3oSjNA" className="w-full md:w-1/3 justify-center">
    <UsersIcon className="size-3.5" aria-hidden="true" /> Join Our Community
  </ButtonLink>
</div>
