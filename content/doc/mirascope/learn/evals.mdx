...
<Info title="Include all relevant information" collapsible={true} defaultCollapsed={true}>
...
<Info title="Async for parallel evaluations" collapsible={true} defaultCollapsed={true}>
