...
![Lilypad Homepage](/assets/blog/langsmith-alternatives/lilypad-homepage.png)
...
![Answer Qustion Version 1 Trace](/assets/blog/langsmith-alternatives/answer-question-trace.png)

If you update the function (even slightly), Lilypad automatically creates version 2  and logs it.    

![Answer Question Version 2](/assets/blog/langsmith-alternatives/answer-question-v2.png)

You can also compare function versions by clicking the “Compare” button:  

![Answer Question Click Compare](/assets/blog/langsmith-alternatives/answer-question-click-compare.png)

This toggles a second dropdown menu, where you can select another version and view the differences side-by-side.  

![Answer Question Compare Versions](/assets/blog/langsmith-alternatives/answer-question-compare-versions.png)
...
![Answer Question GenAI OTel Trace Data](/assets/blog/langsmith-alternatives/answer-question-genai-data.png)
...
![Answer Question Playground](/assets/blog/langsmith-alternatives/answer-question-playground.png)
...
![Answer Question Playground Trace](/assets/blog/langsmith-alternatives/answer-question-playground-trace.png)
...
![Answer Question Assign Annotation](/assets/blog/langsmith-alternatives/answer-question-assign-annotation.png)  

From there, just click the “Pass” or “Fail” label, add any context or reasoning if you want, and click “submit annotation.”   

![Answer Question Submit Annotation](/assets/blog/langsmith-alternatives/answer-question-submit-annotation.png)
...
![PromptLayer Screenshot](/assets/blog/langsmith-alternatives/prompt-layer-screenshot.png)
...
![Langfuse Screenshot](/assets/blog/langsmith-alternatives/langfuse-screenshot.png) 
...
![Helicone Screenshot](/assets/blog/langsmith-alternatives/helicone-screenshot.png)
...
![Orq AI Screenshot](/assets/blog/langsmith-alternatives/orq-screenshot.png)
...
![Phoenix Screenshot](/assets/blog/langsmith-alternatives/phoenix-screenshot.png)
...
![OpenLLMetry Screenshot](/assets/blog/langsmith-alternatives/openllmetry-screenshot.png)
...
![HoneyHive Screenshot](/assets/blog/langsmith-alternatives/honeyhive-screenshot.png)
...
![Portkey Screenshot](/assets/blog/langsmith-alternatives/portkey-screenshot.png)
