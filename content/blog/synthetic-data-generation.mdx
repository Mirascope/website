...
Below, we walk you through [an example](/docs/mirascope/guides/more_advanced/generating_synthetic_data/) of using OpenAI's GPT-4o-mini to create ecommerce data on home appliances, including attributes like name, price, and inventory.
