...
In contrast, Mirascope implements type safety via its Pydantic-based [response model](/learn/response_models/), enforcing what values functions return, and how LLM calls interact with those functions. 
