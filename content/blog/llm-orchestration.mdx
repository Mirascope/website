...
![IDE Documentation and Linting Example: Argument missing for parameter](/assets/blog/langchain-structured-output/mirascope_prompt_missing_arg.webp)

And providing auto suggestions:

![IDE Auto Suggestions: recommend_book_prompt](/assets/blog/langchain-structured-output/mirascope_prompt_autocomplete.webp)
