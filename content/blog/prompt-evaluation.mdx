...
[Lilypad](/docs/lilypad) allows you to automatically version, trace, and manage prompts (generations) by simply adding the Python decorator `@lilypad.generation` to your LLM functions.  
...
You can find more Mirascope [evaluation tutorials](/docs/mirascope/guides/evals/evaluating_web_search_agent/) both on our [documentation site](/docs/mirascope) and our [GitHub page](https://github.com/mirascope/mirascope).
