...
Our tutorial on [building a web search agent](/docs/mirascope/guides/agents/web-search-agent/) that uses DuckDuckGo to find information relating to your queries provides more details about how automated search works.
