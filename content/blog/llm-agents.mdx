...
Popular techniques like [Chain-of-thought (CoT)](/docs/mirascope/guides/prompt_engineering/text_based/chain_of_thought/) and Tree-of-thought (ToT) prompting or decision trees can help structure this process - enabling the agent to think through problems step by step, especially when dealing with complex multi-step tasks.  
...
You can find more details about the code below in our [tutorial library](/docs/mirascope/guides/agents/local_chat_with_codebase/).
