...
Our own library Lilypad is purpose build for [prompt management](/docs/lilypad), automatically versioning and tracing every LLM call made, including any and all code that could impact the quality of the prompt.
