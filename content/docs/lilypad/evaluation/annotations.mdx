...
![Trace Annotation Sidebar](/assets/docs/lilypad/evaluation/annotations/annotation-sidebar.png)
...
![Trace Discussion](/assets/docs/lilypad/evaluation/annotations/trace-discussion.png)
...
![Click Assign Annotation](/assets/docs/lilypad/evaluation/annotations/click-assign-annotation.png)

![Assign Annotation](/assets/docs/lilypad/evaluation/annotations/assign-annotation.png)
...
![Annotation Queue](/assets/docs/lilypad/evaluation/annotations/annotation-queue.png)
...
import lilypad
from lilypad.lib.traces import Annotation
...
annotation = Annotation(  # [!code highlight]
    label="pass",  # [!code highlight]
