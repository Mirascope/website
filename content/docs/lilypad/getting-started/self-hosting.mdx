...
<Warning title="Lilypad self hosting is currently in a closed beta.">
  ...
  Interested in participating in the closed beta? [Join our community](/discord-invite) and send a message to William Bakst. If we determine it's a good fit, you'll get early access to Pro and Team plan features when self hosting.
</Warning>
