...
lilypad.configure(  # [!code highlight]
    project_id=os.environ["LILYPAD_PROJECT_ID"],  # [!code highlight]
    api_key=os.environ["LILYPAD_API_KEY"],  # [!code highlight]
    auto_llm=True,  # [!code highlight]
)  # [!code highlight]
client = Client()
