...
![Basic Trace](/assets/docs/lilypad/observability/traces/basic-trace.png)
...
![Custom Trace Name](/assets/docs/lilypad/observability/traces/custom-name.png)
...
![Trace With A Log](/assets/docs/lilypad/observability/traces/trace-log.png)

## Tracing LLM Calls

<Warning>
Since LLMs are non-deterministic, we recommend [versioning](./versioning) any functions that use them.
</Warning>
...
![Trace With Auto LLM Span](/assets/docs/lilypad/observability/traces/auto-llm-trace.png)
