...
<ApiSignature>
call(model: str, stream: bool, tools: list[BaseTool | Callable], response_model: BaseModel | BaseType, output_parser: Callable[[AnthropicCallResponse | ResponseModelT], Any], json_mode: bool, client: object, call_params: AnthropicCallParams)
</ApiSignature>
