...
## <ApiType type="Module" module="mirascope.core.openai.stream" path="core/openai/stream" symbolName="stream" /> stream
...
### <ApiType type="Class" module="mirascope.core.openai.stream" path="core/openai/stream" symbolName="OpenAIStream" /> OpenAIStream
