#!/usr/bin/env python3
# Example 1: LLM Evaluators
# Generated for provider: anthropic
# Source: content/docs/mirascope/learn/evals.mdx:28
...
@llm.call(provider="anthropic", model="claude-3-5-sonnet-latest", response_model=Eval)
