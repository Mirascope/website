        ...
        <div className="flex w-full flex-col items-center px-4 text-center">
          ...
          <div className="mt-10 flex w-full flex-col items-center justify-center gap-4 sm:mt-12 sm:flex-row md:mt-14">
            ...
            <ButtonLink
              ...
              variant="outline"
              size="lg"
              className="landing-page-box-shadow landing-page-box-shadow-hover w-full min-w-[220px] border-0 bg-white px-8 py-6 text-center text-lg font-medium text-black hover:bg-gray-200 hover:text-black sm:w-auto"
            >
