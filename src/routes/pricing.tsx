  ...
  <div className="flex items-start space-x-3 py-2">
    <div
      className={cn(
        ...
        included ? "bg-[#e8f5e9]" : "bg-gray-100"
      )}
    >
      {included ? (
    ...
    <span
      className={cn("text-lg", included ? "text-gray-700" : "text-gray-500")}
    >
      {feature}
    </span>
  </div>
...
const FeatureRow = ({
  ...
  return (
    <div className="grid grid-cols-3 gap-4 py-3 border-b border-gray-100 items-center min-h-[48px]">
        ...
        <>
          <div className="text-center">
            {typeof free === "boolean" ? (
              <div className="flex justify-center">
                {free ? (
                  <div className="rounded-full p-1 bg-[#e8f5e9]">
                    <Check size={16} className="text-[#2d8031]" />
                  </div>
                ) : (
              ...
              <span className="text-lg whitespace-pre-line">{free}</span>
            )}
          </div>
          ...
          <div className="text-center">
            {typeof pro === "boolean" ? (
              ...
              <span className="text-lg whitespace-pre-line">{pro}</span>
            )}
          </div>
        </>
      )}
...
const PricingTier = ({
  ...
  <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
    <div
      className={cn(
        "px-6 py-8",
        isGreen ? "bg-gradient-to-br from-[#f0f9f0] to-white" : "bg-white"
      )}
    >
      <h3
        className={cn(
    ...
    <div className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-md text-gray-600 max-w-2xl mx-auto italic">
