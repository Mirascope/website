...
<Info title="Would you rather start with a no-code playground?">
  Check out the [Playground](/docs/lilypad/getting-started/playground) section to get started running and experimenting right in the UI.
</Info>
...
See the [observability](/docs/lilypad/observability) section to learn more.
