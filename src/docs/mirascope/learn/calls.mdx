...
<Info title="API Documentation" collapsible={true} defaultCollapsed={true}>
  [`mirascope.llm.call`](/docs/mirascope/api)
</Info>
...
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/basic_usage/sdk"
  collapsible={true}
...
<Info title="API Documentation" collapsible={true} defaultCollapsed={true}>
  [`mirascope.core.base.call_response`](/docs/mirascope/api)
</Info>
  ...
  <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
    <thead>
      <tr className="bg-accent text-accent-foreground">
        ...
        <th className="px-4 py-2 text-center">Text</th>
        <th className="px-4 py-2 text-center">Audio</th>
    ...
    <tbody>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">Mistral</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
      </tr>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">Groq</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
      </tr>
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">Cohere</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
      </tr>
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">LiteLLM</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
      </tr>
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">Azure AI</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
      </tr>
...
<div className="text-sm text-gray-600 dark:text-gray-400">Legend: ✓ (Supported), - (Not Supported)</div>
...
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/multi_modal_outputs"
  collapsible={false}
  headerText="Multi-Modal Outputs Example"
/>
...
<Warning title="Audio Playback Requirements" collapsible={true} defaultCollapsed={true}>
...
<Note title="Voice Options" collapsible={true} defaultCollapsed={true}>
...
@llm.call(provider="$PROVIDER", model="$MODEL", call_params={"max_tokens": 512})
def recommend_book(genre: str) -> str:
    return f"Recommend a {genre} book"
...
<Info title="API Documentation" collapsible={true} defaultCollapsed={true}>
  ...
  - [`mirascope.core.openai.call`](/docs/mirascope/api)
  - [`mirascope.core.anthropic.call`](/docs/mirascope/api)
  - And so on for each supported provider
</Info>
...
<Tab value="Shorthand">
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/basic_usage/shorthand"
  collapsible={false}
  headerText="Provider-Specific Usage"
/>
</Tab>
<Tab value="Template">
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/basic_usage/template"
  collapsible={false}
  headerText="Provider-Specific Usage"
/>
</Tab>
...
<Note title="Reasoning For Provider-Specific BaseCallResponse Objects" collapsible={true} defaultCollapsed={true}>
...
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/custom_messages/sdk"
  collapsible={false}
  headerText="Provider-Specific Messages"
/>
...
<Tab value="Shorthand">
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/custom_client/decorator/shorthand"
  collapsible={false}
  headerText="Provider-Specific Client Configuration"
/>
</Tab>
<Tab value="Template">
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/custom_client/decorator/template"
  collapsible={false}
  headerText="Provider-Specific Client Configuration"
/>
</Tab>
...
<Tab value="Shorthand">
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/custom_client/dynamic_config/shorthand"
  collapsible={false}
  headerText="Dynamic Client Configuration"
/>
</Tab>
<Tab value="Template">
<ProviderCodeBlock 
  examplePath="mirascope/learn/calls/provider_specific/custom_client/dynamic_config/template"
  collapsible={false}
  headerText="Dynamic Client Configuration"
/>
</Tab>
...
<Warning title="Make sure to use the correct client!" collapsible={true} defaultCollapsed={true}>
