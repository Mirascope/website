...
<Warning title="Multi-Line String Templates" collapsible={true} defaultCollapsed={true}>
  ...
  <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
    <thead>
      <tr className="bg-gray-100 dark:bg-gray-700">
        ...
        <th className="px-4 py-2 text-center">Google Gemini</th>
    ...
    <tbody>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">audio</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">video</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">document</td>
        <td className="px-4 py-2 text-center">✓</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
        <td className="px-4 py-2 text-center">-</td>
...
<Info title="Additional String Template Image Functionality" collapsible={true} defaultCollapsed={true}>
...
<Info title="Additional String Template Audio Functionality" collapsible={true} defaultCollapsed={true}>
...
<Note title="Supported Document Types" collapsible={true} defaultCollapsed={true}>
...
<Info title="Additional String Template Document Functionality" collapsible={true} defaultCollapsed={true}>
