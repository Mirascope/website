...
<Info title="Diagram illustrating the flow of asynchronous processing" collapsible={true} defaultCollapsed={true}>
  ```mermaid
  sequenceDiagram
...
@llm.call(provider="$PROVIDER", model="$MODEL", tools=[FormatBook])
async def recommend_book(genre: str) -> str:
    return f"Recommend a {genre} book"
...
<Tab value="Shorthand">
<ProviderCodeBlock 
  examplePath="mirascope/learn/async/custom_client/decorator"
  collapsible={false}
  headerText="Custom Client Decorator"
/>
</Tab>
<Tab value="Template">
<ProviderCodeBlock 
  examplePath="mirascope/learn/async/custom_client/decorator_template"
  collapsible={false}
  headerText="Custom Client Decorator"
/>
</Tab>
...
<Tab value="Shorthand">
<ProviderCodeBlock 
  examplePath="mirascope/learn/async/custom_client/dynamic_config"
  collapsible={false}
  headerText="Custom Client Dynamic Config"
/>
</Tab>
<Tab value="Template">
<ProviderCodeBlock 
  examplePath="mirascope/learn/async/custom_client/dynamic_config_template"
  collapsible={false}
  headerText="Custom Client Dynamic Config"
/>
</Tab>
