...
<ProviderCodeBlock 
  examplePath="mirascope/learn/response_models/basic_usage/official_sdk"
  collapsible={true}
...
<Info title="Tools By Default" collapsible={true} defaultCollapsed={true}>
...
@llm.call(provider="$PROVIDER", model="$MODEL", response_model=list[str])
  ...
  <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700">
    <thead>
      <tr className="bg-gray-100 dark:bg-gray-700">
        ...
        <th className="px-4 py-2 text-center">OpenAI</th>
        <th className="px-4 py-2 text-center">Anthropic</th>
        <th className="px-4 py-2 text-center">Google</th>
        <th className="px-4 py-2 text-center">Groq</th>
        <th className="px-4 py-2 text-center">xAI</th>
        <th className="px-4 py-2 text-center">Mistral</th>
        <th className="px-4 py-2 text-center">Cohere</th>
      </tr>
    </thead>
    <tbody>
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">str</td>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">bool</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">bytes</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">-✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">list</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">set</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">--</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">tuple</td>
        <td className="px-4 py-2 text-center">-✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">-✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">dict</td>
        <td className="px-4 py-2 text-center">-✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">Literal/Enum</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">BaseModel</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
      ...
      <tr className="bg-gray-50 dark:bg-gray-900 border-t border-gray-300 dark:border-gray-700">
        <td className="px-4 py-2 font-medium">Nested ($def)</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
        <td className="px-4 py-2 text-center">✓✓</td>
...
<div className="text-sm text-gray-600 dark:text-gray-400">Legend: ✓✓ (Fully Supported), -✓ (Only JSON Mode Support), -- (Not Supported)</div>
...
@llm.call(provider="$PROVIDER", model="$MODEL", response_model=Book, stream=True)
def extract_book(text: str) -> str:
    return f"Extract {text}"
