...
<Info title="Diagram illustrating standard vs. streaming responses" collapsible={true} defaultCollapsed={true}>
    ```mermaid
    sequenceDiagram
        participant User
        participant App
...
<Info title="API Documentation" collapsible={true} defaultCollapsed={true}>
    [`mirascope.core.base.stream`](/docs/mirascope/api)
</Info>
...
<Info title="API Documentation" collapsible={true} defaultCollapsed={true}>
    [`mirascope.core.base.call_response_chunk`](/docs/mirascope/api)
</Info>
...
<ProviderCodeBlock 
  examplePath="mirascope/learn/streams/multi_modal_outputs"
  collapsible={false}
...
<ProviderCodeBlock 
  examplePath="mirascope/learn/streams/error_handling"
  collapsible={false}
  headerText="Error Handling Example"
/>
