...
<div className="flex flex-wrap gap-4 my-6">
  <a href=".." className="inline-flex items-center px-6 py-3 border border-blue-400 dark:border-blue-500 text-base font-medium rounded-md text-blue-500 dark:text-blue-400 bg-transparent hover:bg-blue-50 dark:hover:bg-blue-900/20">
    🚀 Quick Start
  </a>
