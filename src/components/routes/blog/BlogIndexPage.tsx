    ...
    if (isMobile) {
      return (
        <button
          ...
          className={`flex h-9 w-9 items-center justify-center rounded-md border ${currentPage === 1 ? "pointer-events-none opacity-50" : "hover:bg-muted cursor-pointer"}`}
    ...
    if (isMobile) {
      return (
        <button
          ...
          className={`flex h-9 w-9 items-center justify-center rounded-md border ${currentPage === totalPages ? "pointer-events-none opacity-50" : "hover:bg-muted cursor-pointer"}`}
