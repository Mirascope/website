...
## Theme Sentinel Test
<div className="p-6 my-6 border rounded-lg shadow-sm">
  <h3 className="text-lg font-medium mb-4">Theme Sentinel Color</h3>
  <div className="w-full h-24 bg-sentinel flex items-center justify-center text-white font-bold">
    This color changes with theme: Green (light) / Purple (dark) / Orange (sunset)
  </div>
  <code className="text-xs mt-4 block">bg-sentinel - Use theme selector in header to test different themes</code>
</div>
